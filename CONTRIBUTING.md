...
Select an [issue](https://github.com/adrienfort/PoCorn/issues) that you want to resolve.

The recommended workflow is to fork this repository and open pull requests from your fork.

### 1. Fork, clone & configure PoCorn upstream
...
git clone git@github.com:adrienfort/PoCorn.git

# Add your fork as a remove
git remote add <fork_name> https://github.com/$YOUR_GITHUB_USER/PoCorn.git
```
...
# Create a new pull request from https://github.com/adrienfort/PoCorn/pulls
```
